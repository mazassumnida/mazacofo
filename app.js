    ...
    client.fetch(url, {}, (err, $, result) => {
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="381" height="105.309" viewBox="0 0 381 105.309">
            ...
            <g id="name_bar" data-name="name &amp; bar" transform="translate(-7 1)">
                <text id="${userInfo.id}" transform="translate(23 27)" fill="#ff8c00" font-size="26" font-family="Segoe UI Bold, Segoe UI" font-weight="900"><tspan x="0" y="20">GUMGOOD</tspan></text>
                <rect id="사각형_1" data-name="사각형 1" width="315" height="6" transform="translate(19 66)" fill="#ff8c00"/>
                <text id="_1900" data-name="1900" transform="translate(311 84)" fill="#ff8c00" font-size="10" font-family="SegoeUI-Semibold, Segoe UI" font-weight="700"><tspan x="0" y="0">1900</tspan></text>
                <text id="_1300" data-name="1300" transform="translate(219 83)" fill="#ff8c00" font-size="10" font-family="SegoeUI-Semibold, Segoe UI" font-weight="700"><tspan x="0" y="0">${userInfo.rating}</tspan></text>
                <rect id="사각형_2" data-name="사각형 2" width="105" height="6" transform="translate(229 66)" fill="#707070"/>
                <text id="Master" transform="translate(23 29)" fill="#ff8c00" font-size="16" font-family="Helvetica-Bold, Helvetica" font-weight="700"><tspan x="0" y="0">${userInfo.rank}</tspan></text>
            </g>
            <g id="max" transform="translate(188 -77.573)">
                <text id="TopRating_" data-name="TopRating"
            transform="translate(26 132.573)" fill="#fff" font-size="12" font-family="Helvetica"><tspan x="0" y="0">Top Rating</tspan><tspan font-family="SegoeUI-Semibold, Segoe UI" font-weight="600"><tspan x="0" y="14"></tspan></tspan></text>
                <text id="maxRank" transform="translate(26 118.573)" fill="#fff" font-size="12" font-family="Helvetica"><tspan x="0" y="0">max Rank</tspan></text>
                <text id="Master-2" data-name="Master" transform="translate(100 105.573)" fill="#e0e" font-size="12" font-family="Helvetica-Bold, Helvetica" font-weight="700"><tspan x="0" y="9">${userInfo.maxRank}</tspan></text>
                <text id="_2200" data-name="2200" transform="translate(100 120.573)" fill="#e0e" font-size="12" font-family="Helvetica-Bold, Helvetica" font-weight="700"><tspan x="0" y="9">${userInfo.maxRating}</tspan></text>
            </g>
    </svg>
    `)
    })
