import { RANK_EXP, TIER_COLOR, MINI_COLOR } from "./cofoRatingInfo";
import type { TClient } from "packages/database/client-table-service";

export const svgDataForLGM = (client: TClient) => {
  const str = `
...
export const svgDataForGeneralRating = (client: TClient) => {
  const str = `
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="350" height="131" viewBox="0 0 350 131">
  <defs>
  <clipPath id="clip-맞춤형_크기_39">
...
export const svgDataMini = (client: TClient) => {
