    ...
    client.fetch(url, {}, (err, $, result) => {
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="381" height="105.309" viewBox="0 0 381 105.309">
            ...
            `)
                ...
                res.send(`
        <svg xmlns="http://www.w3.org/2000/svg" width="396" height="105.309" viewBox="0 0 381 105.309">
            <style type="text/css">
                <![CDATA[
                    @import url(https://cdn.jsdelivr.net/npm/segoe-fonts@1.0.1/segoe-fonts.min.css);
                ]]>
            ...
            <g id="name_bar" data-name="name &amp; bar" transform="translate(-7 1)">
                ...
                <text id="_1300" data-name="1300" transform="translate(${(userInfo.rating - RANK_EXP[userInfo.rank]['min']) / (RANK_EXP[userInfo.rank]['max'] - RANK_EXP[userInfo.rank]['min']) * (334 - 19) + 20} 90)" fill="#FF0000" font-size="11" font-family="Segoe UI Semibold, Segoe UI" font-weight="700"><tspan x="0" y="0">${userInfo.rating}</tspan></text>
            ...
            transform="translate(20 126)" fill="#fff" font-size="12" font-family="Segoe UI Semibold"><tspan x="0" y="0">Top Rating</tspan><tspan font-family="Segoe UI Semibold, Segoe UI" font-weight="600"><tspan x="0" y="14"></tspan></tspan></text>
                ...
                <text id="_2200" data-name="2200" transform="translate(20 133)" fill="${TIER_COLOR[userInfo.rank]['remains']}" font-size="0.9em" font-family="Segoe UI Bold, Segoe UI" font-weight="700"><tspan x="0" y="8">${userInfo.maxRating}</tspan></text>
            </g>
        </svg>
                `)
            }
